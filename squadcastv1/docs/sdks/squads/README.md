...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.SquadsGetAllSquadsRequest](../../models/operations/squadsgetallsquadsrequest.md)                                                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
<!-- UsageSnippet language="typescript" operationID="Squads_createSquad" method="post" path="/v4/squads" -->
```typescript
import { SquadcastSDK } from "@solarwinds/squadcast-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="Squads_deleteSquad" method="delete" path="/v4/squads/{squadID}" -->
```typescript
import { SquadcastSDK } from "@solarwinds/squadcast-sdk-typescript";
