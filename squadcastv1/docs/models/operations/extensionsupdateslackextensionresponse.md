...
```typescript
import { ExtensionsUpdateSlackExtensionResponse } from "SquadcastSDK/models/operations";

let value: ExtensionsUpdateSlackExtensionResponse = {
  data: {
    id: 727757,
    serviceId: "<id>",
    organizationId: "<id>",
    channelId: "<id>",
    createdAt: "1726457138291",
    name: "<value>",
  },
};
```
