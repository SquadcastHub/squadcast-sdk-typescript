...
```typescript
import { GlobalEventRulesUpdateGlobalEventRuleByIdResponse } from "@solarwinds/squadcast-sdk-typescript/models/operations";

let value: GlobalEventRulesUpdateGlobalEventRuleByIdResponse = {
  data: {
    id: 532580,
    ownerId: "<id>",
    name: "<value>",
