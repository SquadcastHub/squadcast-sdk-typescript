...
```typescript
import { ServicesDelayedNotificationConfigResponse } from "@solarwinds/squadcast-sdk-typescript/models/operations";

let value: ServicesDelayedNotificationConfigResponse = {
  data: {
    id: "<id>",
    name: "<value>",
    slug: "<value>",
