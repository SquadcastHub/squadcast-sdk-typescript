...
```typescript
import { CommunicationCardsCreateCommunicationCardResponse } from "SquadcastSDK/models/operations";

let value: CommunicationCardsCreateCommunicationCardResponse = {
  data: {
