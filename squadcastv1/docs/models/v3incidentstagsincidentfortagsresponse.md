...
```typescript
import { V3IncidentsTagsIncidentForTagsResponse } from "SquadcastSDK/models";
...
let value: V3IncidentsTagsIncidentForTagsResponse = {
  ...
  status: "<value>",
  timeOfCreation: new Date("2025-01-02T11:20:44.419Z"),
  updatedAt: new Date("2023-04-28T12:32:26.252Z"),
  tags: {},
  logs: [],
  analytics: {
    tta: {
  ...
  relevantPeopleLogs: [
    {
      ...
      actionTaken: "<value>",
      actionTakenBy: "<value>",
      actionTime: new Date("2023-10-10T09:04:49.161Z"),
    },
  ],
  responseNotes: [
    {
  ...
  autoPauseEndsAt: new Date("2025-01-09T18:31:26.070Z"),
