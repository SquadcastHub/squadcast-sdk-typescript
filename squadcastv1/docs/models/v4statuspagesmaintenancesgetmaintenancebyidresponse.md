...
```typescript
import { V4StatusPagesMaintenancesGetMaintenanceByIdResponse } from "@solarwinds/squadcast-sdk-typescript/models";

let value: V4StatusPagesMaintenancesGetMaintenanceByIdResponse = {
  id: 874384,
  pageID: 128064,
  title: "<value>",
  note: "<value>",
...
| `componentIDList`                                                                             | *number*[]                                                                                    | :heavy_minus_sign:                                                                            | N/A                                                                                           |
