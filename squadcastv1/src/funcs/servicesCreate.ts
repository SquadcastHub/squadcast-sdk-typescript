...
export function servicesCreate(
  ...
  Result<
    operations.ServicesCreateServiceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ServicesCreateServiceRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["V3.Services.CreateServiceRequest"], {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.ServicesCreateServiceResponse$inboundSchema),
