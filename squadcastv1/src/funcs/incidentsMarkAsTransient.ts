 ...
 * Mark as Transient
 */
export function incidentsMarkAsTransient(
  client: SquadcastSDKCore,
  request: operations.AptaMarkAsTransientRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AptaMarkAsTransientResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AptaMarkAsTransientRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AptaMarkAsTransientResponse$inboundSchema),
