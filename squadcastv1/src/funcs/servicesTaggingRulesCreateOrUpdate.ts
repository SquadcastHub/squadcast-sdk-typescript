 ...
 */
export function servicesTaggingRulesCreateOrUpdate(
  client: SquadcastSDKCore,
  request: operations.TaggingRulesCreateOrUpdateTaggingRulesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TaggingRulesCreateOrUpdateTaggingRulesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TaggingRulesCreateOrUpdateTaggingRulesRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Services.TaggingRules.CreateOrUpdateTaggingRulesRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/services/{serviceID}/tagging-rules")(pathParams);
  ...
  >(
    M.json(
      201,
      operations.TaggingRulesCreateOrUpdateTaggingRulesResponse$inboundSchema,
    ),
