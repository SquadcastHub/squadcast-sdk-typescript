 ...
 */
export function servicesUpdateSlackExtension(
  client: SquadcastSDKCore,
  request: operations.ExtensionsUpdateSlackExtensionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ExtensionsUpdateSlackExtensionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ExtensionsUpdateSlackExtensionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Services.Extensions.UpdateSlackExtensionRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/services/{serviceID}/extensions")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.ExtensionsUpdateSlackExtensionResponse$inboundSchema,
    ),
