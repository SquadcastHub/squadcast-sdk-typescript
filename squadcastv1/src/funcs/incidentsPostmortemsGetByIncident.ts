 ...
 */
export function incidentsPostmortemsGetByIncident(
  client: SquadcastSDKCore,
  request: operations.PostmortemsGetPostmortemByIncidentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostmortemsGetPostmortemByIncidentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostmortemsGetPostmortemByIncidentRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.PostmortemsGetPostmortemByIncidentResponse$inboundSchema,
    ),
