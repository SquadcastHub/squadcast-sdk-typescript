 ...
 */
export function incidentsCommunicationCardsCreate(
  client: SquadcastSDKCore,
  request: operations.CommunicationCardsCreateCommunicationCardRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CommunicationCardsCreateCommunicationCardResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CommunicationCardsCreateCommunicationCardRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.CommunicationCards.CreateCommunicationCardRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/incidents/{IncidentId}/communication_cards")(
    pathParams,
  );
