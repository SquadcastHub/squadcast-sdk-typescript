 ...
 * List Subscribers
 */
export function statusPageSubscribersList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StatusPagesListSubscribersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v4/statuspages/{statuspageID}/subscribers")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.V4StatusPagesListSubscribersResponse$inboundSchema),
