...
export function incidentsV3BulkAcknowledge(
  ...
  Result<
    operations.IncidentsBulkAcknowledgeIncidentsResponse,
...
> {
  ...
  const path = pathToFunc("/v3/incidents/acknowledge")();
  ...
  >(
    M.json(
      200,
      operations.IncidentsBulkAcknowledgeIncidentsResponse$inboundSchema,
    ),
