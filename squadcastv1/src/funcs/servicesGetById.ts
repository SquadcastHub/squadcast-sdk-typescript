...
export function servicesGetById(
  ...
  Result<
    operations.ServicesGetServiceByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ServicesGetServiceByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ServicesGetServiceByIdResponse$inboundSchema),
