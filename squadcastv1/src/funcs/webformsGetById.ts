...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WebformsGetWebformByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WebformsGetWebformByIdResponse$inboundSchema),
