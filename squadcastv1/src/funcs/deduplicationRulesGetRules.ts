 ...
 */
export function deduplicationRulesGetRules(
  client: SquadcastSDKCore,
  request: operations.DeduplicationRulesGetDeduplicationRulesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeduplicationRulesGetDeduplicationRulesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeduplicationRulesGetDeduplicationRulesRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v3/services/{serviceID}/deduplication-rules")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.DeduplicationRulesGetDeduplicationRulesResponse$inboundSchema,
    ),
