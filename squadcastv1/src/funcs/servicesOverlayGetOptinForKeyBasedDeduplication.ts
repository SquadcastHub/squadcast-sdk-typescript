 ...
 */
export function servicesOverlayGetOptinForKeyBasedDeduplication(
  client: SquadcastSDKCore,
  request: operations.OverlayGetOptinForKeyBasedDeduplicationForAServiceRequest,
...
> {
  ...
  const path = pathToFunc("/v3/services/{serviceID}/config")(pathParams);
