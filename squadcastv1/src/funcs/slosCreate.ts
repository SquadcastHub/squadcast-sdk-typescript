...
> {
  const parsed = safeParse(
    request,
    (value) => models.V3SLOCreateSLORequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.SLOCreateSLOResponse$inboundSchema),
