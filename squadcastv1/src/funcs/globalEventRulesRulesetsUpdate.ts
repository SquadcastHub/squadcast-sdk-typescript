 ...
 */
export function globalEventRulesRulesetsUpdate(
  client: SquadcastSDKCore,
  request: operations.GlobalEventRulesUpdateRulesetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesUpdateRulesetResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesUpdateRulesetRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.GlobalEventRules.UpdateRulesetRequest"],
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GlobalEventRulesUpdateRulesetResponse$inboundSchema),
