...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IssuesDeleteIssueByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IssuesDeleteIssueByIdResponse$inboundSchema),
