...
export function schedulesCreate(
  ...
  Result<
    operations.SchedulesCreateScheduleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.V4CreateScheduleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.SchedulesCreateScheduleResponse$inboundSchema),
    M.jsonErr(
