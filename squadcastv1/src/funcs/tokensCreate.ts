...
export function tokensCreate(
  ...
  Result<
    operations.UsersCreateTokenResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UsersCreateTokenRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/refresh-token")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.UsersCreateTokenResponse$inboundSchema),
