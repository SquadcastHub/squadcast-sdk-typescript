...
> {
  const parsed = safeParse(
    request,
    (value) => operations.IssuesCreateIssueRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V4.StatusPages.Issues.CreateIssueRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v4/statuspages/{statuspageID}/issues")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IssuesCreateIssueResponse$inboundSchema),
