 ...
 */
export function incidentsArchiveSlackChannel(
  client: SquadcastSDKCore,
  request: models.V3IncidentsCommunicationCardsArchiveSlackChannelRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CommunicationCardsArchiveSlackChannelResponse,
...
> {
  ...
  const path = pathToFunc("/v3/extensions/slack_v2/channel/archive")();
  ...
  >(
    M.json(
      200,
      operations.CommunicationCardsArchiveSlackChannelResponse$inboundSchema,
    ),
