...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TeamsCreateTeamRoleRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["V3.Teams.CreateTeamRoleRequest"], {
    explode: true,
  });
  ...
  const path = pathToFunc("/v3/teams/{teamId}/roles")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.TeamsCreateTeamRoleResponse$inboundSchema),
