 ...
 * Get a GER Ruleset
 */
export function globalEventRulesRulesetsGet(
  client: SquadcastSDKCore,
  request: operations.GlobalEventRulesGetRulesetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesGetRulesetResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesGetRulesetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GlobalEventRulesGetRulesetResponse$inboundSchema),
