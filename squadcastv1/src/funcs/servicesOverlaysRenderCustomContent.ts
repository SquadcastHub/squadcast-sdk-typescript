 ...
 */
export function servicesOverlaysRenderCustomContent(
  client: SquadcastSDKCore,
  request: operations.OverlayRenderCustomContentOverlayRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OverlayRenderCustomContentOverlayResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OverlayRenderCustomContentOverlayRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Services.Overlay.RenderCustomContentOverlayRequest"],
    { explode: true },
  );
  ...
  >(
    M.json(
      200,
      operations.OverlayRenderCustomContentOverlayResponse$inboundSchema,
    ),
