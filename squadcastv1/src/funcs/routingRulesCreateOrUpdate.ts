 ...
 */
export function routingRulesCreateOrUpdate(
  client: SquadcastSDKCore,
  request: operations.RoutingRulesCreateOrUpdateRoutingRulesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RoutingRulesCreateOrUpdateRoutingRulesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RoutingRulesCreateOrUpdateRoutingRulesRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Services.RoutingRules.CreateOrUpdateRoutingRulesRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/services/{serviceID}/routing-rules")(pathParams);
  ...
  >(
    M.json(
      201,
      operations.RoutingRulesCreateOrUpdateRoutingRulesResponse$inboundSchema,
    ),
