 ...
 */
export function servicesMaintenanceGet(
  client: SquadcastSDKCore,
  request: operations.MaintenanceModeGetMaintenanceModeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MaintenanceModeGetMaintenanceModeResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MaintenanceModeGetMaintenanceModeRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v3/services/{serviceID}/maintenance")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.MaintenanceModeGetMaintenanceModeResponse$inboundSchema,
    ),
