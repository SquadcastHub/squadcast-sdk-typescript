 ...
 */
export function workflowsUpdateAction(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WorkflowsUpdateWorkflowActionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload["V3.Workflows.ActionRequestUpdate"], {
    explode: true,
  });
