 ...
 */
export function incidentsBulkUpdatePriority(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3IncidentsBulkIncidentsPriorityUpdateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v3/incidents/priority")();
