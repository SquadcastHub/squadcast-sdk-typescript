...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentsReassignIncidentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.ReassignIncidentRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}/reassign")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IncidentsReassignIncidentResponse$inboundSchema),
