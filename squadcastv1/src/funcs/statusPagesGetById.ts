 ...
 */
export function statusPagesGetById(
  client: SquadcastSDKCore,
  request: operations.StatusPagesGetStatusPageByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StatusPagesGetStatusPageByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StatusPagesGetStatusPageByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.StatusPagesGetStatusPageByIdResponse$inboundSchema),
