 ...
 */
export function servicesDependenciesCreateOrUpdate(
  client: SquadcastSDKCore,
  request: operations.DependenciesCreateOrUpdateDependenciesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DependenciesCreateOrUpdateDependenciesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DependenciesCreateOrUpdateDependenciesRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Services.Dependencies.CreateOrUpdateDependenciesRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/services/{serviceID}/dependencies")(pathParams);
  ...
  >(
    M.json(
      201,
      operations.DependenciesCreateOrUpdateDependenciesResponse$inboundSchema,
    ),
