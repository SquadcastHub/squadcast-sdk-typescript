...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuditLogsGetAuditLogByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/audit-logs/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.V3AuditLogsGetAuditLogByIDResponse$inboundSchema),
