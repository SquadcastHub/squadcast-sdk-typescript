 ...
 */
export function usersRemoveToken(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UsersRemoveTokenRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    refreshTokenID: encodeSimple("refreshTokenID", payload.refreshTokenID, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/v3/refresh-token/{refreshTokenID}")(pathParams);
