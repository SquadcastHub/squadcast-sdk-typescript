...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ExportGetExportDetailsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/exports/{export_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ExportGetExportDetailsResponse$inboundSchema),
