 ...
 */
export function workflowsEnableDisable(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WorkflowsEnabledisableWorkflowRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Workflows.EnableDisableWorkflowRequest"],
    { explode: true },
  );
