 ...
 */
export function statusPagesComponentGroupsCreate(
  client: SquadcastSDKCore,
  request: operations.ComponentGroupsCreateComponentGroupRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComponentGroupsCreateComponentGroupResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComponentGroupsCreateComponentGroupRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V4.StatusPages.ComponentGroups.CreateComponentGroupRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v4/statuspages/{statuspageID}/groups")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.ComponentGroupsCreateComponentGroupResponse$inboundSchema,
    ),
