 ...
 */
export function incidentsAutoPauseTransientAlertsMarkAsNotTransient(
  client: SquadcastSDKCore,
  request: operations.AptaMarkAsNotTransientRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AptaMarkAsNotTransientResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AptaMarkAsNotTransientRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}/mark-as-non-transient")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AptaMarkAsNotTransientResponse$inboundSchema),
