 ...
 */
export function rotationsGetParticipants(
  client: SquadcastSDKCore,
  request: operations.RotationsGetRotationParticipantsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RotationsGetRotationParticipantsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RotationsGetRotationParticipantsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.RotationsGetRotationParticipantsResponse$inboundSchema,
    ),
    M.jsonErr(
