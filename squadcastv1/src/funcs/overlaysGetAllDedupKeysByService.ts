 ...
 */
export function overlaysGetAllDedupKeysByService(
  client: SquadcastSDKCore,
  request: operations.OverlayGetAllDedupKeyOverlayByServiceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OverlayGetAllDedupKeyOverlayByServiceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OverlayGetAllDedupKeyOverlayByServiceRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v3/services/{serviceID}/overlays/dedup-key")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.OverlayGetAllDedupKeyOverlayByServiceResponse$inboundSchema,
    ),
