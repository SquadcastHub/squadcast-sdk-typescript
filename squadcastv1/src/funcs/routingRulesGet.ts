...
export function routingRulesGet(
  ...
  Result<
    operations.RoutingRulesGetRoutingRulesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RoutingRulesGetRoutingRulesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RoutingRulesGetRoutingRulesResponse$inboundSchema),
