 ...
 */
export function incidentsMarkSloFalsePositive(
  client: SquadcastSDKCore,
  request: operations.IncidentsMarkIncidentSloFalsePositiveRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IncidentsMarkIncidentSloFalsePositiveResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentsMarkIncidentSloFalsePositiveRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.IncidentsMarkIncidentSloFalsePositiveResponse$inboundSchema,
    ),
