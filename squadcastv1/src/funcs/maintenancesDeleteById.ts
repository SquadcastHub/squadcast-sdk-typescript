 ...
 */
export function maintenancesDeleteById(
  client: SquadcastSDKCore,
  request: operations.MaintenancesDeleteMaintenanceByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MaintenancesDeleteMaintenanceByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MaintenancesDeleteMaintenanceByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.MaintenancesDeleteMaintenanceByIdResponse$inboundSchema,
    ),
