...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AnalyticsGetTeamAnalyticsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/analyticsv2/team")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyticsGetTeamAnalyticsResponse$inboundSchema),
