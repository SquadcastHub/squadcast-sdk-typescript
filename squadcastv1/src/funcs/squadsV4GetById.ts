...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SquadsGetSquadByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SquadsGetSquadByIdResponse$inboundSchema),
    M.jsonErr(
