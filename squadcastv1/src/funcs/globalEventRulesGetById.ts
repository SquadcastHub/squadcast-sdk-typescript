 ...
 * Get a GER by its ID
 */
export function globalEventRulesGetById(
  client: SquadcastSDKCore,
  request: operations.GlobalEventRulesGetGlobalEventRuleByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesGetGlobalEventRuleByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesGetGlobalEventRuleByIdRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.GlobalEventRulesGetGlobalEventRuleByIdResponse$inboundSchema,
    ),
