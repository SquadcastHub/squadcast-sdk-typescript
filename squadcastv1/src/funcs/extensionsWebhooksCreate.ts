 ...
 */
export function extensionsWebhooksCreate(
  client: SquadcastSDKCore,
  request: models.V3ExtensionsWebhooksWebhook,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.WebhooksCreateWebhookResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.V3ExtensionsWebhooksWebhook$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/extensions/event-webhooks")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.WebhooksCreateWebhookResponse$inboundSchema),
