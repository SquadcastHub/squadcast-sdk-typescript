 ...
 */
export function servicesOverlaysGetCustomContentTemplate(
  client: SquadcastSDKCore,
  request: operations.OverlayGetCustomContentTemplateOverlayRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OverlayGetCustomContentTemplateOverlayResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OverlayGetCustomContentTemplateOverlayRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.OverlayGetCustomContentTemplateOverlayResponse$inboundSchema,
    ),
