...
export function workflowsCreate(
  ...
  Result<
    operations.WorkflowsCreateWorkflowResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3WorkflowsCreateWorkflowRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/workflows")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.WorkflowsCreateWorkflowResponse$inboundSchema),
