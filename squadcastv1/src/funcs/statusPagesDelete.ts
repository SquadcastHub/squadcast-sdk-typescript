...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StatusPagesDeleteStatusPageByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.StatusPagesDeleteStatusPageByIdResponse$inboundSchema,
    ),
