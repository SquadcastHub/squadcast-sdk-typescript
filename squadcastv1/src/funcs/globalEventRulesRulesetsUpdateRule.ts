 ...
 */
export function globalEventRulesRulesetsUpdateRule(
  client: SquadcastSDKCore,
  request: operations.GlobalEventRulesUpdateRuleByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesUpdateRuleByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesUpdateRuleByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.GlobalEventRules.UpdateRuleRequest"],
    { explode: true },
  );
  ...
  >(
    M.json(
      200,
      operations.GlobalEventRulesUpdateRuleByIdResponse$inboundSchema,
    ),
