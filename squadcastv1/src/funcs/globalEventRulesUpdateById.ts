 ...
 */
export function globalEventRulesUpdateById(
  client: SquadcastSDKCore,
  request: operations.GlobalEventRulesUpdateGlobalEventRuleByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesUpdateGlobalEventRuleByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesUpdateGlobalEventRuleByIdRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.GlobalEventRules.UpdateGlobalEventRuleRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/global-event-rules/{ger_id}")(pathParams);
