 ...
 */
export function rotationsGetScheduleRotations(
  client: SquadcastSDKCore,
  request: operations.RotationsGetScheduleRotationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RotationsGetScheduleRotationsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RotationsGetScheduleRotationsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RotationsGetScheduleRotationsResponse$inboundSchema),
    M.jsonErr(
