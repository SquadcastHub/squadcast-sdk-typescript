 ...
 */
export function workflowsUpdateActionsOrder(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WorkflowsUpdateActionsOrderRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Workflows.UpdateActionsOrderRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/workflows/{workflowID}/actions/reorder")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.V3WorkflowsUpdateActionsOrderResponse$inboundSchema),
