 ...
 */
export function dedupKeyOverlaysGetForAlertSource(
  client: SquadcastSDKCore,
  request: operations.OverlayGetDedupKeyOverlayForAlertSourceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OverlayGetDedupKeyOverlayForAlertSourceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OverlayGetDedupKeyOverlayForAlertSourceRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.OverlayGetDedupKeyOverlayForAlertSourceResponse$inboundSchema,
    ),
