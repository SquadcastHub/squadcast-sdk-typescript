 ...
 */
export function teamsMembersBulkAdd(
  client: SquadcastSDKCore,
  request: operations.TeamsAddBulkTeamMemberRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TeamsAddBulkTeamMemberResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TeamsAddBulkTeamMemberRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Teams.AddBulkTeamMemberRequest"],
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TeamsAddBulkTeamMemberResponse$inboundSchema),
