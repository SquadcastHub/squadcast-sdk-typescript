...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WebhooksGetWebhookByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WebhooksGetWebhookByIdResponse$inboundSchema),
