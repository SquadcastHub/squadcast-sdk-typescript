 ...
 */
export function slosMarkFalsePositive(
  client: SquadcastSDKCore,
  request: operations.SLOMarkSLOFalsePositiveRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SLOMarkSLOFalsePositiveResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SLOMarkSLOFalsePositiveRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    value: encodeSimple("value", payload.value, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SLOMarkSLOFalsePositiveResponse$inboundSchema),
