 ...
 */
export function incidentsBulkResolve(
  client: SquadcastSDKCore,
  request: models.V3IncidentsBulkIncidentIDsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IncidentsBulkResolveIncidentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3IncidentsBulkIncidentIDsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/incidents/resolve")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IncidentsBulkResolveIncidentsResponse$inboundSchema),
