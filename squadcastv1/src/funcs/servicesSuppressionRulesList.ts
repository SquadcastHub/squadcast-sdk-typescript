 ...
 */
export function servicesSuppressionRulesList(
  client: SquadcastSDKCore,
  request: operations.SuppressionRulesGetSuppressionRulesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SuppressionRulesGetSuppressionRulesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SuppressionRulesGetSuppressionRulesRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v3/services/{serviceID}/suppression-rules")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.SuppressionRulesGetSuppressionRulesResponse$inboundSchema,
    ),
