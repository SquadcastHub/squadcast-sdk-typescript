 ...
 * ```
 */
export function incidentsEventsList(
  client: SquadcastSDKCore,
  request: operations.IncidentsGetIncidentEventsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IncidentsGetIncidentEventsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentsGetIncidentEventsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}/events")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IncidentsGetIncidentEventsResponse$inboundSchema),
