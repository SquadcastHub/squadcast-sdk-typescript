 ...
 */
export function incidentsCreateJiraServerTicket(
  client: SquadcastSDKCore,
  request: operations.IncidentActionsCreateATicketOnJiraServerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IncidentActionsCreateATicketOnJiraServerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentActionsCreateATicketOnJiraServerRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.IncidentActionsCreateATicketOnJiraServerResponse$inboundSchema,
    ),
