 ...
 * List Issues
 */
export function statusPagesIssuesList(
  client: SquadcastSDKCore,
  request: operations.IssuesListIssuesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.V4StatusPagesIssuesListIssuesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.IssuesListIssuesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.V4StatusPagesIssuesListIssuesResponse$inboundSchema),
