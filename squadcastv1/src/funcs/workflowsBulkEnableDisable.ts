 ...
 */
export function workflowsBulkEnableDisable(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3WorkflowsBulkEnableDisableWorkflowsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v3/workflows/enable")();
