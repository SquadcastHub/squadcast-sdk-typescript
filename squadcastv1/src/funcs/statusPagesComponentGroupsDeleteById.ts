 ...
 */
export function statusPagesComponentGroupsDeleteById(
  client: SquadcastSDKCore,
  request: operations.ComponentGroupsDeleteComponentGroupByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComponentGroupsDeleteComponentGroupByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComponentGroupsDeleteComponentGroupByIdRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v4/statuspages/{statuspageID}/groups/{group_id}")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.ComponentGroupsDeleteComponentGroupByIdResponse$inboundSchema,
    ),
