...
export function slosList(
  ...
  Result<
    operations.SLOGetAllSLOsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SLOGetAllSLOsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SLOGetAllSLOsResponse$inboundSchema),
