...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SchedulesCloneScheduleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.SchedulesCloneScheduleResponse$inboundSchema),
    M.jsonErr(
