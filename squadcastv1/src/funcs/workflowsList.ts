...
export function workflowsList(
  ...
  Result<
    models.V3WorkflowsListWorkflowAPIResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WorkflowsListWorkflowsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.V3WorkflowsListWorkflowAPIResponse$inboundSchema),
