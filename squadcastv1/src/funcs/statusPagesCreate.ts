 ...
 * Create Status Page
 */
export function statusPagesCreate(
  client: SquadcastSDKCore,
  request: models.V4StatusPagesCreateStatusPageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StatusPagesCreateStatusPageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V4StatusPagesCreateStatusPageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.StatusPagesCreateStatusPageResponse$inboundSchema),
