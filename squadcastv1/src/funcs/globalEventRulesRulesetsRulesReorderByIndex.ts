 ...
 */
export function globalEventRulesRulesetsRulesReorderByIndex(
  client: SquadcastSDKCore,
  request: operations.GlobalEventRulesReorderRulesetByIndexRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesReorderRulesetByIndexResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesReorderRulesetByIndexRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.GlobalEventRules.ReorderRuleRequest"],
    { explode: true },
  );

  const pathParams = {
    alert_source_shortname: encodeSimple(
      "alert_source_shortname",
      payload.alert_source_shortname,
      { explode: false, charEncoding: "percent" },
    ),
    alert_source_version: encodeSimple(
      "alert_source_version",
      payload.alert_source_version,
      { explode: false, charEncoding: "percent" },
    ),
    ger_id: encodeSimple("ger_id", payload.ger_id, {
      explode: false,
  ...
  >(
    M.json(
      200,
      operations.GlobalEventRulesReorderRulesetByIndexResponse$inboundSchema,
    ),
