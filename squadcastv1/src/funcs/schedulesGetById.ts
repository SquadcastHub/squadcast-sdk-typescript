...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SchedulesGetScheduleByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SchedulesGetScheduleByIdResponse$inboundSchema),
    M.jsonErr(
