...
export function usersDelete(
  ...
  Result<
    operations.UsersDeleteUserResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UsersDeleteUserRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/users/delete-user")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UsersDeleteUserResponse$inboundSchema),
