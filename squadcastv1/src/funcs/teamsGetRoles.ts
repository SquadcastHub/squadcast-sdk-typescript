...
export function teamsGetRoles(
  ...
  Result<
    operations.TeamsGetAllTeamRolesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TeamsGetAllTeamRolesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TeamsGetAllTeamRolesResponse$inboundSchema),
