...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WorkflowsGetWorkflowLogsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/workflows/{workflowID}/logs")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.V3WorkflowsGetWorkflowLogsResponse$inboundSchema),
