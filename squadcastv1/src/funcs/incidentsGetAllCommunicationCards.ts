 ...
 */
export function incidentsGetAllCommunicationCards(
  client: SquadcastSDKCore,
  request: operations.CommunicationCardsGetAllCommunicationCardRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CommunicationCardsGetAllCommunicationCardResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CommunicationCardsGetAllCommunicationCardRequest$outboundSchema
        .parse(value),
