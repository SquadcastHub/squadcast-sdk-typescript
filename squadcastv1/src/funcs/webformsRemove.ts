...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WebformsRemoveWebformRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WebformsRemoveWebformResponse$inboundSchema),
