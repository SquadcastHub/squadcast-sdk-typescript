 ...
 */
export function escalationPoliciesCreate(
  client: SquadcastSDKCore,
  request: models.V3EscalationPoliciesCreateEscalationPolicyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.EscalationPoliciesCreateEscalationPoliciesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3EscalationPoliciesCreateEscalationPolicyRequest$outboundSchema
        .parse(value),
