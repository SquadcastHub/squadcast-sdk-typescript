 ...
 */
export function incidentActionsCircleciRebuild(
  client: SquadcastSDKCore,
  request: operations.IncidentActionsRebuildAProjectInCircleciRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IncidentActionsRebuildAProjectInCircleciResponse,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentActionsRebuildAProjectInCircleciRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.IncidentActions.RebuildCircleCIProjectRequest"],
    { explode: true },
  );

  const pathParams = {
    buildNumber: encodeSimple("buildNumber", payload.buildNumber, {
      explode: false,
  ...
  >(
    M.json(
      200,
      operations.IncidentActionsRebuildAProjectInCircleciResponse$inboundSchema,
    ),
