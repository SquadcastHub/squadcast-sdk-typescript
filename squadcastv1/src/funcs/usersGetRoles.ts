 ...
 */
export function usersGetRoles(
  client: SquadcastSDKCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UsersGetUserRolesResponse,
...
> {
  const path = pathToFunc("/v3/users/roles")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UsersGetUserRolesResponse$inboundSchema),
