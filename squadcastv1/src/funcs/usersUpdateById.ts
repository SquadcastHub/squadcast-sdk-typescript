...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UsersUpdateUserByIDRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["V3.Users.UpdateUserRequest"], {
    explode: true,
  });
  ...
  const path = pathToFunc("/v3/users/{userID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UsersUpdateUserByIDResponse$inboundSchema),
