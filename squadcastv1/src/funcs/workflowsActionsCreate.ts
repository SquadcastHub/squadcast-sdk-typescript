 ...
 */
export function workflowsActionsCreate(
  client: SquadcastSDKCore,
  request: operations.WorkflowsCreateActionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.WorkflowsCreateActionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WorkflowsCreateActionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["V3.Workflows.ActionRequest"], {
    explode: true,
  });
  ...
  const path = pathToFunc("/v3/workflows/{workflowID}/actions")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.WorkflowsCreateActionResponse$inboundSchema),
