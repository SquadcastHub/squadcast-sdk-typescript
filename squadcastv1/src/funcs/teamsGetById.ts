...
export function teamsGetById(
  ...
  Result<
    operations.TeamsGetTeamByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TeamsGetTeamByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TeamsGetTeamByIdResponse$inboundSchema),
