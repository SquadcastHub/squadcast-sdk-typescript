 ...
 */
export function postmortemsDeleteByIncident(
  client: SquadcastSDKCore,
  request: operations.PostmortemsDeletePostmortemByIncidentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostmortemsDeletePostmortemByIncidentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostmortemsDeletePostmortemByIncidentRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.PostmortemsDeletePostmortemByIncidentResponse$inboundSchema,
    ),
