 ...
 */
export function extensionsMsteamsGetConfig(
  client: SquadcastSDKCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MSTeamsGetMsteamsConfigResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MSTeamsGetMsteamsConfigResponse$inboundSchema),
