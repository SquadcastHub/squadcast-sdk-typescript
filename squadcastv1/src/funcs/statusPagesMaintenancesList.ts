 ...
 * List Maintenances
 */
export function statusPagesMaintenancesList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MaintenancesListMaintenancesRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      models.V4StatusPagesMaintenancesListMaintenancesResponse$inboundSchema,
    ),
