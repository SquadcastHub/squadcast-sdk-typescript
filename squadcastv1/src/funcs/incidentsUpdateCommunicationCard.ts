 ...
 */
export function incidentsUpdateCommunicationCard(
  client: SquadcastSDKCore,
  request: operations.CommunicationCardsUpdateCommunicationCardRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CommunicationCardsUpdateCommunicationCardResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CommunicationCardsUpdateCommunicationCardRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.CommunicationCards.UpdateCommunicationCardRequest"],
    { explode: true },
  );
  ...
  const pathParams = {
    ...
    communicationCardId: encodeSimple(
      "communicationCardId",
      payload.communicationCardId,
