 ...
 */
export function statusPagesListStatuses(
  client: SquadcastSDKCore,
  request: operations.StatusPagesListStatusPageStatusesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StatusPagesListStatusPageStatusesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StatusPagesListStatusPageStatusesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v4/statuspages/{statuspageID}/status")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.StatusPagesListStatusPageStatusesResponse$inboundSchema,
    ),
