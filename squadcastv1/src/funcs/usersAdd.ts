...
export function usersAdd(
  ...
  Result<
    operations.UsersAddUserResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.V3UsersAddUserRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/users")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.UsersAddUserResponse$inboundSchema),
