 ...
 */
export function globalEventRulesRulesetsRulesGet(
  client: SquadcastSDKCore,
  request: operations.GlobalEventRulesGetRuleByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesGetRuleByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesGetRuleByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GlobalEventRulesGetRuleByIdResponse$inboundSchema),
