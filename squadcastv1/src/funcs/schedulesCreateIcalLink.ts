 ...
 */
export function schedulesCreateIcalLink(
  client: SquadcastSDKCore,
  request: operations.ExportCreateScheduleIcalLinkRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ExportCreateScheduleIcalLinkResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ExportCreateScheduleIcalLinkRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ExportCreateScheduleIcalLinkResponse$inboundSchema),
    M.jsonErr(
