 ...
 */
export function schedulesOverridesCreate(
  client: SquadcastSDKCore,
  request: operations.OverridesCreateScheduleOverrideRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OverridesCreateScheduleOverrideResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OverridesCreateScheduleOverrideRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload["V4.CreateScheduleOverrideRequest"], {
    explode: true,
  });
  ...
  >(
    M.json(
      201,
      operations.OverridesCreateScheduleOverrideResponse$inboundSchema,
    ),
    M.jsonErr(
