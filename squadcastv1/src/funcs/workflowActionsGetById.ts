 ...
 * Get workflow action by ID
 */
export function workflowActionsGetById(
  client: SquadcastSDKCore,
  request: operations.WorkflowsGetWorkflowActionByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.WorkflowsGetWorkflowActionByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WorkflowsGetWorkflowActionByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    actionID: encodeSimple("actionID", payload.actionID, {
      explode: false,
  ...
  const path = pathToFunc("/v3/workflows/{workflowID}/actions/{actionID}")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.WorkflowsGetWorkflowActionByIdResponse$inboundSchema,
    ),
