...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TeamsAddTeamMemberRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["V3.Teams.AddTeamMemberRequest"], {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.TeamsAddTeamMemberResponse$inboundSchema),
