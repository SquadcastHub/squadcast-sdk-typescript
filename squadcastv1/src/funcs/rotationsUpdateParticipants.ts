 ...
 */
export function rotationsUpdateParticipants(
  client: SquadcastSDKCore,
  request: operations.RotationsUpdateRotationParticipantsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RotationsUpdateRotationParticipantsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RotationsUpdateRotationParticipantsRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V4.UpdateRotationParticipantsRequest"],
    { explode: true },
  );
  ...
  >(
    M.json(
      200,
      operations.RotationsUpdateRotationParticipantsResponse$inboundSchema,
    ),
    M.jsonErr(
