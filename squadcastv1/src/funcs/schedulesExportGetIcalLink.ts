 ...
 */
export function schedulesExportGetIcalLink(
  client: SquadcastSDKCore,
  request: operations.ExportGetScheduleIcalLinkRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ExportGetScheduleIcalLinkResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ExportGetScheduleIcalLinkRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ExportGetScheduleIcalLinkResponse$inboundSchema),
    M.jsonErr(
