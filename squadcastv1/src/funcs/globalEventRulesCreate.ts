 ...
 * Create a GER
 */
export function globalEventRulesCreate(
  client: SquadcastSDKCore,
  request: models.V3GlobalEventRulesCreateGlobalEventRuleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesCreateGlobalEventRuleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3GlobalEventRulesCreateGlobalEventRuleRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      201,
      operations.GlobalEventRulesCreateGlobalEventRuleResponse$inboundSchema,
    ),
