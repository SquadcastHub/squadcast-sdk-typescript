 ...
 */
export function globalEventRulesRulesetsCreateRule(
  client: SquadcastSDKCore,
  request: operations.GlobalEventRulesCreateRuleRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GlobalEventRulesCreateRuleResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesCreateRuleRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.GlobalEventRules.CreateOrUpdateRuleRequest"],
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.GlobalEventRulesCreateRuleResponse$inboundSchema),
