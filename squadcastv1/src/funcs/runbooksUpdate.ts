...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RunbooksUpdateRunbookRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["V3.Runbooks.UpdateRunbookRequest"], {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RunbooksUpdateRunbookResponse$inboundSchema),
