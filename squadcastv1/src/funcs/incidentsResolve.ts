...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentsResolveIncidentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.ResolveIncidentRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}/resolve")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IncidentsResolveIncidentResponse$inboundSchema),
