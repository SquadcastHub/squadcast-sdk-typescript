 ...
 */
export function runbooksListByTeam(
  client: SquadcastSDKCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RunbooksGetAllRunbooksByTeamResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RunbooksGetAllRunbooksByTeamResponse$inboundSchema),
