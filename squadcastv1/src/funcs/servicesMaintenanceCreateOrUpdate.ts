 ...
 */
export function servicesMaintenanceCreateOrUpdate(
  client: SquadcastSDKCore,
  request: operations.MaintenanceModeCreateOrUpdateMaintenanceModeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MaintenanceModeCreateOrUpdateMaintenanceModeResponse,
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Services.MaintenanceMode.CreateOrUpdateMaintenanceModeRequest"],
    { explode: true },
  );
