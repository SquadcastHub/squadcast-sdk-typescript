 ...
 */
export function incidentsExportAsync(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3IncidentsIncidentExportAsyncRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/incidents/export/async")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.bytes(202, b64$.zodInbound, { ctype: "*/*" }),
