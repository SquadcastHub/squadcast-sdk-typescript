 ...
 */
export function escalationPoliciesGetById(
  client: SquadcastSDKCore,
  request: operations.EscalationPoliciesGetEscalationPolicyByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.EscalationPoliciesGetEscalationPolicyByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.EscalationPoliciesGetEscalationPolicyByIdRequest$outboundSchema
        .parse(value),
