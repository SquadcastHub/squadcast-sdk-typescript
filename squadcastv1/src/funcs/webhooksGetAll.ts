 ...
 */
export function webhooksGetAll(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WebhooksGetAllWebhooksRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      models.V3ExtensionsWebhooksGetAllWebhooksResponse$inboundSchema,
    ),
