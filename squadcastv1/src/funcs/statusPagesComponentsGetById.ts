 ...
 * Get Component By ID
 */
export function statusPagesComponentsGetById(
  client: SquadcastSDKCore,
  request: operations.ComponentsGetComponentByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComponentsGetComponentByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComponentsGetComponentByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComponentsGetComponentByIdResponse$inboundSchema),
