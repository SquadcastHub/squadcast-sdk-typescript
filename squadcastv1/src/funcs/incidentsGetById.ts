...
export function incidentsGetById(
  ...
  Result<
    operations.IncidentsGetIncidentByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentsGetIncidentByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IncidentsGetIncidentByIdResponse$inboundSchema),
