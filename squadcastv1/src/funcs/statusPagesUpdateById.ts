 ...
 */
export function statusPagesUpdateById(
  client: SquadcastSDKCore,
  request: operations.StatusPagesUpdateStatusPageByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StatusPagesUpdateStatusPageByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StatusPagesUpdateStatusPageByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload["V4.StatusPages.UpdateStatusPageByIdRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v4/statuspages/{statuspageID}")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.StatusPagesUpdateStatusPageByIdResponse$inboundSchema,
    ),
