 ...
 */
export function incidentsAdditionalRespondersAdd(
  client: SquadcastSDKCore,
  request: operations.AdditionalRespondersAddAdditionalRespondersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AdditionalRespondersAddAdditionalRespondersResponse,
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.AdditionalResponders.AddAdditionalRespondersRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}/additional-responders")(
    pathParams,
  );
