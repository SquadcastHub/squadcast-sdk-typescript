 ...
 */
export function statusPagesComponentGroupsGetById(
  client: SquadcastSDKCore,
  request: operations.ComponentGroupsGetComponentGroupByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComponentGroupsGetComponentGroupByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComponentGroupsGetComponentGroupByIdRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.ComponentGroupsGetComponentGroupByIdResponse$inboundSchema,
    ),
