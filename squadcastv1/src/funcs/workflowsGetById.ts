 ...
 */
export function workflowsGetById(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.WorkflowsGetWorkflowByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.V3WorkflowsGetWorkflowByIdResponse$inboundSchema),
