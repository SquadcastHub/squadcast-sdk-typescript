 ...
 */
export function servicesListByName(
  client: SquadcastSDKCore,
  request: operations.ServicesGetServicesByNameRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ServicesGetServicesByNameResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ServicesGetServicesByNameRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/services/by-name")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ServicesGetServicesByNameResponse$inboundSchema),
