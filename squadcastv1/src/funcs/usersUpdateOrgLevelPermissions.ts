 ...
 */
export function usersUpdateOrgLevelPermissions(
  client: SquadcastSDKCore,
  request: models.V3UsersUpdateUserAbilitiesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UsersUpdateOrgLevelPermissionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3UsersUpdateUserAbilitiesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/users/abilities")();
  ...
  >(
    M.json(
      200,
      operations.UsersUpdateOrgLevelPermissionsResponse$inboundSchema,
    ),
