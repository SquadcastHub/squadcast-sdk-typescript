 ...
 */
export function squadsMembersRemove(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SquadsRemoveSquadMemberRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.V4SquadsRemoveSquadMemberResponse$inboundSchema),
    M.jsonErr(
