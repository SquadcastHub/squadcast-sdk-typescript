 ...
 * Get Issue By ID
 */
export function statusPagesGetIssueById(
  client: SquadcastSDKCore,
  request: operations.IssuesGetIssueByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IssuesGetIssueByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.IssuesGetIssueByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IssuesGetIssueByIdResponse$inboundSchema),
