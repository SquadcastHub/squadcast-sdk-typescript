 ...
 * Append Tag
 */
export function incidentsTagsAppend(
  client: SquadcastSDKCore,
  request: operations.TagsAppendTagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TagsAppendTagResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TagsAppendTagRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.Tags.AppendTagRequest"],
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TagsAppendTagResponse$inboundSchema),
