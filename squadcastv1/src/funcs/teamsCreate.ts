...
export function teamsCreate(
  ...
  Result<
    operations.TeamsCreateTeamResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.V3TeamsCreateTeamRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/teams")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.TeamsCreateTeamResponse$inboundSchema),
