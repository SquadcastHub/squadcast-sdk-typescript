...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SquadsGetSquadByTeamRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/squads")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SquadsGetSquadByTeamResponse$inboundSchema),
