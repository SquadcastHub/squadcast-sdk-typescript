 ...
 */
export function componentsDeleteById(
  client: SquadcastSDKCore,
  request: operations.ComponentsDeleteComponentByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComponentsDeleteComponentByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComponentsDeleteComponentByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComponentsDeleteComponentByIdResponse$inboundSchema),
