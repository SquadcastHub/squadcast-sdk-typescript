...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TeamsGetAllTeamMembersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TeamsGetAllTeamMembersResponse$inboundSchema),
