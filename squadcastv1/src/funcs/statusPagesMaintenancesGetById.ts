 ...
 */
export function statusPagesMaintenancesGetById(
  client: SquadcastSDKCore,
  request: operations.MaintenancesGetMaintenanceByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MaintenancesGetMaintenanceByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MaintenancesGetMaintenanceByIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.MaintenancesGetMaintenanceByIdResponse$inboundSchema,
    ),
