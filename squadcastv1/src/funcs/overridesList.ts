...
export function overridesList(
  ...
  Result<
    operations.OverridesListOverridesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OverridesListOverridesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.OverridesListOverridesResponse$inboundSchema),
    M.jsonErr(
