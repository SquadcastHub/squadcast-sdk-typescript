 ...
 */
export function incidentsPostmortemsCreate(
  client: SquadcastSDKCore,
  request: operations.PostmortemsCreatePostmortemRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostmortemsCreatePostmortemResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostmortemsCreatePostmortemRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.Postmortems.CreatePostmortemRequest"],
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostmortemsCreatePostmortemResponse$inboundSchema),
