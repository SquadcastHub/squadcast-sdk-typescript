 ...
 * Get Override by ID
 */
export function schedulesGetOverrideById(
  client: SquadcastSDKCore,
  request: operations.OverridesGetOverrideByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OverridesGetOverrideByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OverridesGetOverrideByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.OverridesGetOverrideByIdResponse$inboundSchema),
    M.jsonErr(
