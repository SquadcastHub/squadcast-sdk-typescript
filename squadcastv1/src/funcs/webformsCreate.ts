...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.V3WebformsCreateOrUpdateWebformRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/webform")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.WebformsCreateWebformResponse$inboundSchema),
