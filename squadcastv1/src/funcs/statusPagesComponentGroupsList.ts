 ...
 */
export function statusPagesComponentGroupsList(
  client: SquadcastSDKCore,
  request: operations.ComponentGroupsListComponentGroupsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComponentGroupsListComponentGroupsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComponentGroupsListComponentGroupsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ComponentGroupsListComponentGroupsResponse$inboundSchema,
    ),
