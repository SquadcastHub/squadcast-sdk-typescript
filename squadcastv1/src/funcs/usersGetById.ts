...
export function usersGetById(
  ...
  Result<
    operations.UsersGetUserByIdResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UsersGetUserByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UsersGetUserByIdResponse$inboundSchema),
