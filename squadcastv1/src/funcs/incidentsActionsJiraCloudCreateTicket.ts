 ...
 */
export function incidentsActionsJiraCloudCreateTicket(
  client: SquadcastSDKCore,
  request: operations.IncidentActionsCreateATicketOnJiraCloudRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IncidentActionsCreateATicketOnJiraCloudResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentActionsCreateATicketOnJiraCloudRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.IncidentActionsCreateATicketOnJiraCloudResponse$inboundSchema,
    ),
