 ...
 */
export function servicesCreateOrUpdateIAGConfig(
  client: SquadcastSDKCore,
  request: operations.ServicesCreateOrUpdateIAGConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ServicesCreateOrUpdateIAGConfigResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ServicesCreateOrUpdateIAGConfigRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload["V3.Services.IAGConfigRequest"], {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.ServicesCreateOrUpdateIAGConfigResponse$inboundSchema,
    ),
