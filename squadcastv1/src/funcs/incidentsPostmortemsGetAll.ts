 ...
 */
export function incidentsPostmortemsGetAll(
  client: SquadcastSDKCore,
  request: operations.PostmortemsGetAllPostmortemsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostmortemsGetAllPostmortemsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostmortemsGetAllPostmortemsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v3/incidents/postmortem")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PostmortemsGetAllPostmortemsResponse$inboundSchema),
