 ...
 */
export function communicationCardsDelete(
  client: SquadcastSDKCore,
  request: operations.CommunicationCardsDeleteCommunicationCardRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CommunicationCardsDeleteCommunicationCardResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CommunicationCardsDeleteCommunicationCardRequest$outboundSchema
        .parse(value),
