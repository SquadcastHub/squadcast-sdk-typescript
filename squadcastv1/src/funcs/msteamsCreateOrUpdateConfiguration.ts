 ...
 */
export function msteamsCreateOrUpdateConfiguration(
  client: SquadcastSDKCore,
  request: models.V3ExtensionsMSTeamsCreateOrUpdateMSTeamsConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MSTeamsCreateOrUpdateMsteamsConfigurationResponse,
...
> {
  ...
  const path = pathToFunc("/v3/extensions/msteams/config")();
