 ...
 */
export function incidentsNotesList(
  client: SquadcastSDKCore,
  request: operations.NotesGetAllNotesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.NotesGetAllNotesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.NotesGetAllNotesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.NotesGetAllNotesResponse$inboundSchema),
