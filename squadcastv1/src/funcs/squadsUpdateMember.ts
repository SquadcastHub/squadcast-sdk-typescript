 ...
 */
export function squadsUpdateMember(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SquadsUpdateSquadMemberRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V4.Squads.UpdateSquadMemberRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v4/squads/{squadID}/members/{memberID}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.V4SquadsUpdateSquadMemberResponse$inboundSchema),
    M.jsonErr(
