 ...
 */
export function globalEventRulesRulesetsListRules(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GlobalEventRulesListRulesetRulesRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GlobalEventRulesListRulesetRulesResponse$inboundSchema,
    ),
