 ...
 */
export function incidentsTriggerWebhook(
  client: SquadcastSDKCore,
  request: operations.IncidentActionsTriggerAWebhookManuallyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IncidentActionsTriggerAWebhookManuallyResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentActionsTriggerAWebhookManuallyRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.IncidentActionsTriggerAWebhookManuallyResponse$inboundSchema,
    ),
