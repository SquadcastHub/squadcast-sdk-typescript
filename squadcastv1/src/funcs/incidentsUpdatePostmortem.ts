 ...
 */
export function incidentsUpdatePostmortem(
  client: SquadcastSDKCore,
  request: operations.PostmortemsUpdatePostmortemByIncidentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostmortemsUpdatePostmortemByIncidentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostmortemsUpdatePostmortemByIncidentRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.Postmortems.UpdatePostmortemRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}/postmortem")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.PostmortemsUpdatePostmortemByIncidentResponse$inboundSchema,
    ),
