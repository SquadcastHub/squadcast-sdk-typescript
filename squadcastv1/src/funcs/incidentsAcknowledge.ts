 ...
 */
export function incidentsAcknowledge(
  client: SquadcastSDKCore,
  request: operations.IncidentsAcknowledgeIncidentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.IncidentsAcknowledgeIncidentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IncidentsAcknowledgeIncidentRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}/acknowledge")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IncidentsAcknowledgeIncidentResponse$inboundSchema),
