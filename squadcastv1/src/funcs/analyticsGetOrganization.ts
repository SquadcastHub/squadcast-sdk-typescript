 ...
 * Get Org level analytics
 */
export function analyticsGetOrganization(
  client: SquadcastSDKCore,
  request: operations.AnalyticsGetOrgAnalyticsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AnalyticsGetOrgAnalyticsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AnalyticsGetOrgAnalyticsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v3/analyticsv2/organization")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AnalyticsGetOrgAnalyticsResponse$inboundSchema),
