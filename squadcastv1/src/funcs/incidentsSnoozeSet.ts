 ...
 */
export function incidentsSnoozeSet(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload["V3.Incidents.SnoozeNotifications.SnoozeIncidentRequest"],
    { explode: true },
  );
  ...
  const path = pathToFunc("/v3/incidents/{incidentID}/snooze")(pathParams);
