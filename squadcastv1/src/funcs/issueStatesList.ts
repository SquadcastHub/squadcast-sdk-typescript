...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IssuesListStatusPageIssueStatesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v4/statuspages/{statuspageID}/states")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.IssuesListStatusPageIssueStatesResponse$inboundSchema,
    ),
