 ...
 * Get Tagging Rules
 */
export function servicesTaggingRulesList(
  client: SquadcastSDKCore,
  request: operations.TaggingRulesGetTaggingRulesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TaggingRulesGetTaggingRulesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TaggingRulesGetTaggingRulesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TaggingRulesGetTaggingRulesResponse$inboundSchema),
