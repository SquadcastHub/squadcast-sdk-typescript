...
export function componentsList(
  ...
  Result<
    operations.ComponentsListComponentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComponentsListComponentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComponentsListComponentsResponse$inboundSchema),
