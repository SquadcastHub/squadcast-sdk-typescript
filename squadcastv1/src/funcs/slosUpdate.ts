...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SLOUpdateSLORequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["V3.SLO.CreateSLORequest"], {
    explode: true,
  });
  ...
  const path = pathToFunc("/v3/slo/{sloID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SLOUpdateSLOResponse$inboundSchema),
