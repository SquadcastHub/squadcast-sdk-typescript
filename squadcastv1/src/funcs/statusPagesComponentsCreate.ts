 ...
 * Create Component
 */
export function statusPagesComponentsCreate(
  client: SquadcastSDKCore,
  request: operations.ComponentsCreateComponentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ComponentsCreateComponentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ComponentsCreateComponentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload["V4.StatusPages.Components.CreateComponentRequest"],
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ComponentsCreateComponentResponse$inboundSchema),
